...
describe GetsProducts do
  ...
  context '#all' do
    it 'gets all products' do
      ...
      GetsProducts.new.all.should =~ [first_product.value, second_product.value]
    end
    ...
    it 'gets all products for a store' do
      ...
      GetsProducts.new(store_id: first_product.store_id).all.should =~ [first_product.value]
    end
  end
  ...
  context '#find_by_id' do
    it 'gets a single product' do
      ...
      GetsProducts.new.find_by_id(product.id).should eq product.value
    end
